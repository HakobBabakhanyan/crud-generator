...
window.Swiper = __webpack_require__(/*! swiper/js/swiper.min */ "./node_modules/swiper/js/swiper.min.js");

__webpack_require__(/*! ./custom */ "./resources/js/site/custom.js");
...
function circle_animate(element, start) {
  var diameter = element.width() / 2;
  var element_animate = $(element.data('animate'));
  var elements = element_animate.find('.elements');
  element_animate.css({
    'top': diameter - elements.width() / 2 + 'px',
    'left': diameter - elements.width() / 2 + 'px'
  });
  var type = 0.5,
...
var open_button = $('.open-dropdown');

if (open_button.length) {
  open_button.on('click', function () {
    var parent = $(this).closest('.dropdown-custom');
...
var click_next_h_full = $('.click-next-h-full');
...
__webpack_require__(/*! C:\OSPanel\domains\admin-HB\resources\js\site\app.js */"./resources/js/site/app.js");
module.exports = __webpack_require__(/*! C:\OSPanel\domains\admin-HB\resources\sass\site\app.scss */"./resources/sass/site/app.scss");
